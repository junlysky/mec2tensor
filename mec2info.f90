...
write(521,"(20A8)")"lon","lat","str1","dip1","rake1","str2","dip2","rake2","mrr","mtt","mpp","mrt","mrp","mtp",&
...
do i=1,total-1
   ...
   write(*,81)lon,lat,ANGS,ANGS2(2),ANGS2(1),ANGS2(3),MOMTEN,PTTP(1),PTTP(2),ANBTP(5),ANBTP(6),PTTP(3),PTTP(4)
   write(521,81)lon,lat,ANGS,ANGS2(2),ANGS2(1),ANGS2(3),MOMTEN,PTTP(1),PTTP(2),ANBTP(5),ANBTP(6),PTTP(3),PTTP(4) 
81 format(20F8.2)
end do
